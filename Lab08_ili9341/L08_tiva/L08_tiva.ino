...
void setup() {
  ...
  //LCD_Bitmap(unsigned int x, unsigned int y, unsigned int width, unsigned int height, unsigned char bitmap[]);
       LCD_Bitmap(0, 0, 320, 240, windows);

       //LCD_Bitmap(0, 0, 230, 240, walle);
       //  for(int x = 0; x <319; x++){
...
//**************************************************************
//            FUNCION PARA CONVERTIR DE HEX A ASCII
//**************************************************************
int ascii_hex(int a) {
  switch (a) {
    case 48:
